...
export default function Auth() {
  ...
  const [accepted, setAccepted] = useState(() => {
    try { return localStorage.getItem('cogamegm_terms_accepted') === 'true' } catch { return false }
  })

  function acceptTerms() {
    try { localStorage.setItem('cogamegm_terms_accepted', 'true') } catch {}
    setAccepted(true)
  }
  ...
  return (
    <div style={s.wrap}>
      ...
      <div style={s.card}>
        ...
        {/* Legal / copyright */}
        {!accepted && (
          <div style={{ padding: '16px 20px', borderTop: '1px solid #2a1f55' }}>
            <div style={{ fontSize: 10, fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#6050a0', marginBottom: 10 }}>
              Terms of use & copyright
            </div>
            <div style={{ fontSize: 11, color: '#5a4880', lineHeight: 1.7, marginBottom: 12, maxHeight: 140, overflowY: 'auto', paddingRight: 4 }}>
              <strong style={{ color: '#8070b0' }}>© 2026 Co-Game GM. All rights reserved.</strong><br />
              Co-Game GM is an AI-assisted tool for tabletop RPG game masters. All content generated by this app — including scene descriptions, NPC profiles, creature descriptions, and images — is produced by AI and is provided for personal, non-commercial gaming use only.<br /><br />
              <strong style={{ color: '#8070b0' }}>Intellectual property:</strong> Co-Game GM does not claim ownership of any referenced game system rules, settings, or lore belonging to their respective publishers (Wizards of the Coast, Darrington Press, Paizo, Marvel Entertainment, Free League Publishing, and others). All trademarks and copyrights remain the property of their respective owners.<br /><br />
              <strong style={{ color: '#8070b0' }}>User content:</strong> Any campaign lore, custom rules, or content you upload remains your own intellectual property. By using this service you confirm you have the right to use any content you upload.<br /><br />
              <strong style={{ color: '#8070b0' }}>Privacy:</strong> Your campaign data is stored securely in your personal account. We do not sell or share your data with third parties.<br /><br />
              <strong style={{ color: '#8070b0' }}>Beta access:</strong> This app is currently in beta. Features may change and data loss is possible. Use at your own risk.<br /><br />
              By clicking "Accept & continue" you agree to these terms and confirm you are using this tool for personal, non-commercial tabletop gaming purposes.
            </div>
            <button
              style={{ width: '100%', padding: 11, background: 'linear-gradient(135deg, #5030b0, #7040d0)', border: 'none', borderRadius: 10, color: '#e8d8ff', fontSize: 13, fontWeight: 600, cursor: 'pointer', fontFamily: "'Cinzel', Georgia, serif", letterSpacing: 0.5 }}
              onClick={acceptTerms}>
              ✦ Accept &amp; continue
            </button>
          </div>
        ...
        {/* Form — only shown after accepting terms */}
        {accepted && <div style={s.formSection}>
          <div style={s.modeRow}>
