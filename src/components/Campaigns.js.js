...
const s = {
  ...
  createToggleBtn: { padding: '10px 16px', background: 'transparent', color: '#a49fc8', border: '1px solid #2d2a4a', borderRadius: 8, fontSize: 13, fontWeight: 600, cursor: 'pointer', marginBottom: 12, display: 'block' },
  createFormCard: { background: '#1a1830', border: '1px solid #2d2a4a', borderRadius: 12, padding: '16px 20px', marginBottom: 12 },
